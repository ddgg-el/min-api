...
if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${TEST_NAME}.cpp")
	...
	if(DEFINED C74_LIBRARY_TEST_OUTPUT_DIRECTORY )
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY C74_LIBRARY_TEST_OUTPUT_DIRECTORY)
	else()
	...
	if (NOT TARGET mock_kernel)
		if(DEFINED C74_LIBRARY_TEST_OUTPUT_DIRECTORY )
			set(C74_MOCK_TARGET_DIR C74_LIBRARY_TEST_OUTPUT_DIRECTORY)
		else()
